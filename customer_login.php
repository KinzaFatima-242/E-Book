...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  ...
  <button type="submit" class="btn mt-2 mx-auto d-grid gap-2" id="custom_login_btn" name="create">Login</button>
...
<form method="POST" action="code.php" id="custom_login_form">
  ...
  <button type="submit" class="btn mt-3" name="custom_login" id="custom_login_btn">Login</button>
